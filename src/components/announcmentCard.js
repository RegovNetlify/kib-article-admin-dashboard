...
export const AnnouncementCard = (props) => {
  return (
    <Paper
      paperStyle={
        props.secondary
          ? "announcement_card_paper_sec"
          : "announcement_card_paper"
      }
    >
        ...
        <div className="announcement_card_content flex_column">
          {props.tag && (
            <div className={`announcement-tag-wrapper`}>
              {props.tag.map((tag) => {
                return (
                  <div
                    onClick={() => props.handleToggle(tag, 1)}
                    className={`announcement-tag cursor_pointer ${
          ...
          {props.heading && (
            <div
              className={
                props.secondary
                  ? "announcement_card_sub_header_Sec"
                  : "announcement_card_sub_header"
              }
            >
              {props.heading}
            </div>
          ...
          <div
            className={
              props.secondary
                ? "announcement_card_main_text_sec"
                : "announcement_card_main_text"
            }
          >
            {props.main}
          </div>
